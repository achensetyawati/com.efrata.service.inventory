...
{
    public class GarmentLeftoverWarehouseStockBookkeepingReportServiceTest
    {
        ...
        [Fact]
        public async Task Should_Success_GetStockReportTypeFabric()
        {
            ...
            GarmentLeftoverWarehouseStockBookkeepingReportService utilService = new GarmentLeftoverWarehouseStockBookkeepingReportService(_dbContext(GetCurrentMethod()), GetServiceProvider().Object);
            ...
            var result = utilService.GetReport( DateTime.Now, "FABRIC", 1, 1, "{}", 7);
        ...
        public async Task Should_Success_GetFlowStockReportTypeAcc()
        {
            ...
            var result = utilService.GetReport( DateTime.Now, "ACCESSORIES", 1, 1, "{}", 7);
        ...
        public async Task Should_Success_GetFlowStockReportTypeFinishedGood()
        {
            ...
            var result = utilService.GetReport(DateTime.Now, "BARANG JADI", 1, 1, "{}", 7);
        ...
        public async Task Should_Success_GetExcelFlowStockReportTypeFinishedGood()
        {
            ...
            var dataReceiptFinishedGood = _dataUtilFinishedGood(service).GetTestData();
            var result = utilService.GenerateExcel( DateTime.Now, "BARANG JADI", 7);
        ...
        public async Task Should_Success_GetExcelFlowStockReport_ZeroData()
        {
            ...
            var dataReceiptFinishedGood = _dataUtilFinishedGood(service).GetTestData();
            var result = utilService.GenerateExcel(null, "ACCESSORIES", 7);
