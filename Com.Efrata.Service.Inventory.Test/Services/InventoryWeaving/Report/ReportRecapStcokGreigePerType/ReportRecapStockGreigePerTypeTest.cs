...
namespace Com.Ambassador.Service.Inventory.Test.Services.InventoryWeaving.Report.ReportRecapStcokGreigePerType
{
    public class ReportRecapStockGreigePerTypeTest
    {
        private const string ENTITY = "ReportRecapPerType";
        ...
        public async Task Should_success_GetSReportRecap()
        {
            ...
            var Response = Utilservice.GetRecapStocktGreige(DateTime.UtcNow, 7, 25, 1, "{}");
