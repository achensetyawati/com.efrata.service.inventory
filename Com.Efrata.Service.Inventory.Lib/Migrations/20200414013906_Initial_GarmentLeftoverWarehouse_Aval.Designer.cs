...
namespace Com.Efrata.Service.Inventory.Lib.Migrations
{
    ...
    [Migration("20200414013906_Initial_GarmentLeftoverWarehouse_Aval")]
    partial class Initial_GarmentLeftoverWarehouse_Aval
    {
            ...
            modelBuilder.Entity("Com.Efrata.Service.Inventory.Lib.Models.GarmentLeftoverWarehouse.Stock.GarmentLeftoverWarehouseStock", b =>
                {
                    ...
                    b.HasIndex("ReferenceType", "UnitId", "PONo", "RONo", "KG", "ProductId", "UomId")
                        .IsUnique()
                        .HasFilter("[_IsDeleted]=(0)");
