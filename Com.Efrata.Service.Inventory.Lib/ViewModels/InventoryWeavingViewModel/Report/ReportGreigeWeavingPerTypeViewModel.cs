...
namespace Com.Ambassador.Service.Inventory.Lib.ViewModels.InventoryWeavingViewModel.Report
{
    public class ReportGreigeWeavingPerTypeViewModel
    {
    ...
    public class ReportGreigeWeavingDataViewModel : BasicViewModel
    {
        public string MaterialName { get; set; }
        public string WovenType { get; set; }
        public string Yarn1 { get; set; }
