...
{
    public partial class Initial_GarmentLeftoverWarehouseExpenditureAccessories : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GarmentLeftoverWarehouseExpenditureAccessoriesItems",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentLeftoverWarehouseExpenditureAccessoriesItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GarmentLeftoverWarehouseExpenditureAccessoriesItems_GarmentLeftoverWarehouseExpenditureAccessories_ExpenditureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GarmentLeftoverWarehouseExpenditureAccessories_ExpenditureNo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GarmentLeftoverWarehouseExpenditureAccessoriesItems_ExpenditureId_StockId",
