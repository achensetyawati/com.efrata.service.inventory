...
namespace Com.Efrata.Service.Inventory.Lib.Services.GarmentLeftoverWarehouse.Report.Stock
{
    public interface IGarmentLeftoverWarehouseStockReportService 
    {
        ...
        Tuple<List<GarmentLeftoverWarehouseStockMonitoringViewModel>, int> GetMonitoringFinishedGood(DateTime? dateFrom, DateTime? dateTo, int unitId, string ro, int page, int size, string order, int offset);
