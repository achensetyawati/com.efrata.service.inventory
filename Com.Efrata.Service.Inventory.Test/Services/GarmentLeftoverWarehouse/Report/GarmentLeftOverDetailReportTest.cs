...
namespace Com.Ambassador.Service.Inventory.Test.Services.GarmentLeftoverWarehouse.Report
{
    ...
    {
        private const string ENTITY = "detailStockReport";
        ...
        [Fact]
        public async Task Should_Success_GetDetailReportTypeFabric()
        {
            ...
            GarmentLeftoverWarehouseDetailReportService utilService = new GarmentLeftoverWarehouseDetailReportService(_dbContext(GetCurrentMethod()), GetServiceProvider().Object);
            ...
            var result = utilService.GetReportQuery(DateTime.Now, DateTime.Now,"FABRIC", 7);
        ...
        [Fact]
        public async Task Should_Success_GeDetailReportBarangJadi()
        {
            var serviceProvider = GetServiceProvider();
            ...
            var result = utilService.GetReportQuery(DateTime.Now, DateTime.Now,"BARANG JADI", 7);


            Assert.NotNull(result);
        }
        [Fact]
        public async Task Should_Success_GeDetailReportACC()
        {
            var serviceProvider = GetServiceProvider();
            ...
            var dataReceiptAcc = _dataUtilReceiptAcc(receiptAccservice).GetTestData();
            var result = utilService.GetReportQuery(DateTime.Now, DateTime.Now, "ACCESSORIES", 7);
        ...
        public async Task Should_Success_GetFlowStockExcelReport()
        {
            ...
            var dataReceiptAcc = _dataUtilReceiptAcc(receiptAccservice).GetTestData();
            var result = utilService.GenerateExcelDetail("FABRIC",DateTime.Now, DateTime.Now, 7);
