...
{
    public interface IGarmentLeftoverWarehouseReceiptFabricService : IBaseService<GarmentLeftoverWarehouseReceiptFabric, GarmentLeftoverWarehouseReceiptFabricViewModel>
    {
    }
}
