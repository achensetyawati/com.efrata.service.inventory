...
namespace Com.Efrata.Service.Inventory.Lib.PDFTemplates.GarmentLeftoverWarehouse
{
    public class GarmentLeftoverWarehouseExpenditureFabricPDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentLeftoverWarehouseExpenditureFabricViewModel viewModel, List<GarmentProductViewModel> products)
        {
            ...
            Paragraph danliris = new Paragraph("PT. Efrata Garmindo Utama", bold_font);
    ...
    public class GarmentLeftoverWarehouseExpenditureSignPDFTemplatePageEvent : iTextSharp.text.pdf.PdfPageEventHelper
    {
        private string signee;

        public GarmentLeftoverWarehouseExpenditureSignPDFTemplatePageEvent(string signee)
        {
            this.signee = signee;
        }
        public override void OnStartPage(PdfWriter writer, Document document)
        {
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "Penerima,", document.LeftMargin + 100, signY, 0);
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "(_____________________________)", document.LeftMargin + 100, signY - 40, 0);
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, signee, document.LeftMargin + 100, signY - 50, 0);

            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "Pengirim,", document.RightMargin + 450, signY, 0);
